...
``` bash
qiime dada2 denoise-paired --i-demultiplexed-seqs results/02.qiime/01.demux.qza  --p-trunc-len-f 260 --p-trunc-len-r 200  --o-representative-sequences results/02.qiime/03.rep-seqs_v1.qza --o-table results/02.qiime/03.feature-table_v1.qza --o-denoising-stats results/02.qiime/03.denoising-stats_v1.qza --p-n-threads 10
```
...
Y ahora si viene lo divertido, vamos a visualizar nuestros resultados ...

Abre tu editor de Scripts en Rstudio

::: callout-caution
## Revisa tu ubicación

Asegúrate de estar dentro del directorio `taller_amplicones_pozol`
...
# veamos el objeto phyloseq
ps


#obtengamos un resumen de los datos
library(devtools)
library(microbiome)
...
# Revisemos el objeto despues de filtrar
ps2
...
# Creamos un objeto Ampvis
# extraer la otu_table
