...
![GTDB-tk Workflow](Figures/GTDB-tk_worflow.png){fig-align="center" width="444"}
...
Si gtdbtk está tomando mucho tiempo puedes parar el proceso con `ctrl + C` en tu teclado. El resultado final se encuentra en el directorio y archo: `results/10.gtdbtk/gtdbtk.bac120.summary.tsv` que se copió desde el inicio.
:::
...
#Visualización de Datos Creamos un gráfico de barras  que muestra la distribución taxonómica de los bins:
