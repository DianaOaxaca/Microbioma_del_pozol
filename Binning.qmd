...
![Metabat2. Kang et al., 2015. DOI:10.7717/peerj.1165](Figures/04.Metabat.png){alt="Metabat2. Kang et al., 2015. DOI:10.7717/peerj.1165" fig-align="center" width="372"}
...
![DASTool](Figures/06.DASTool.png){alt="DASTool" fig-alt="Sieber et al. 2018. Recovery of genomes from metagenomes via a dereplication, aggregation and scoring strategy. Nat. Micro." fig-align="center" width="935"}
...
``` bash
for i in $(ls ../../08.dastool/48hrs_DASTool_bins/*.fa) ; do name=$(basename $i .fa); ln -s $i $name".fasta" ; done

ln -s ../../07.binning_refiner/48hrs_Binning_refiner_outputs/48hrs_refined_bins/*.fasta .
```
