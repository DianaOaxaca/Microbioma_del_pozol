...
Te dejamos la siguiente línea para que la uses en tus proyectos, además, en [este repositorio](https://github.com/DianaOaxaca/03.Analisis_de_metagenomas) encontrarás los scripts que pueden ser útiles para extraer los bins que cumplan la calidad que buscas:
