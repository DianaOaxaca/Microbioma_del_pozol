...
Para correrlopodemos hacer un ciclo que nos permita anotar todos los *bins.*
...
[KofamScan](https://github.com/takaram/kofam_scan) es una herramienta de anotación que la base de datos de KOfam de KEGG para obtener información sobre los genes que participan en diferentes rutas metabólicas.
...
KofamScan requiere mucho tiempo de ejecución. Para efectos del taller nosotros ya locorrimos y te proporcionaremos los resultados. Te dejamos el bloque de código que usamos para este paso.
